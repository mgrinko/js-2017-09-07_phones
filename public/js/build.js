...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_shop_page_shop_page_js__ = __webpack_require__(5);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shop_page_html__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shop_page_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__shop_page_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_phone_viewer_phone_viewer_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_phone_catalogue_phone_catalogue_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_phone_service_js__ = __webpack_require__(27);
...
class ShopPage {
  constructor(options) {
    ...
    this._template = __WEBPACK_IMPORTED_MODULE_0__shop_page_html___default.a;
    this._render();

    this._viewer = new __WEBPACK_IMPORTED_MODULE_1__components_phone_viewer_phone_viewer_js__["a" /* default */]({
      element: this._element.querySelector('[data-component="phoneViewer"]'),
    });

    this._catalogue = new __WEBPACK_IMPORTED_MODULE_2__components_phone_catalogue_phone_catalogue_js__["a" /* default */]({
      element: this._element.querySelector('[data-component="phoneCatalogue"]'),
    });

    __WEBPACK_IMPORTED_MODULE_3__services_phone_service_js__["a" /* default */].getAll()
      .then((phones) => {
    ...
    this._catalogue.on('phoneSelected', (event) => {
      ...
      __WEBPACK_IMPORTED_MODULE_3__services_phone_service_js__["a" /* default */].get(phoneId)
        .then((phone) => {
...
module.exports = "<!--Sidebar content-->\n<div class=\"col-md-2\">\n  <p>\n    Search:\n    <input>\n  </p>\n\n  <p>\n    Sort by:\n    <select>\n      <option value=\"name\">Alphabetical</option>\n      <option value=\"age\">Newest</option>\n    </select>\n  </p>\n\n  <div>\n    <h4>Shopping cart</h4>\n    <ul>\n      <li>phone1</li>\n      <li>phone2</li>\n      <li>phone3</li>\n    </ul>\n  </div>\n</div>\n\n<!--Body content-->\n<div class=\"col-md-10\">\n  <div data-component=\"phoneCatalogue\"></div>\n  <div data-component=\"phoneViewer\" class=\"js-hidden\"></div>\n</div>"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__phone_viewer_hbs__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__phone_viewer_hbs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__phone_viewer_hbs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component_js__ = __webpack_require__(2);
...
class PhoneViewer extends __WEBPACK_IMPORTED_MODULE_1__component_js__["a" /* default */] {
  constructor(options) {
  ...
  _render(phoneDetails) {
    this._element.innerHTML = __WEBPACK_IMPORTED_MODULE_0__phone_viewer_hbs___default()({
      phone: phoneDetails,
    });
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__phone_catalogue_hbs__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__phone_catalogue_hbs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__phone_catalogue_hbs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component_js__ = __webpack_require__(2);
...
class PhoneCatalogue extends __WEBPACK_IMPORTED_MODULE_1__component_js__["a" /* default */] {
  constructor(options) {
    super(options.element);
  ...
  _render(phones) {
    this._element.innerHTML = __WEBPACK_IMPORTED_MODULE_0__phone_catalogue_hbs___default()({
      phones: phones
    });
  }
}
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n    <li class=\"thumbnail\"\n        data-element=\"phone\"\n        data-phone-id=\""
    + ((stack1 = alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0)) != null ? stack1 : "")
    + "\">\n\n      <a href=\"#!/phones/"
    + ((stack1 = alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0)) != null ? stack1 : "")
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__http_service_js__ = __webpack_require__(28);
